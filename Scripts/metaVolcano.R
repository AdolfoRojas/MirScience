...
important_genes <- meta_degs_vote@metaresult[meta_degs_vote@metaresult$ndeg >= (length(datasets)-1) & meta_degs_vote@metaresult$ndeg == abs(meta_degs_vote@metaresult$ddeg) & meta_degs_vote@metaresult$ndeg > 1,]
